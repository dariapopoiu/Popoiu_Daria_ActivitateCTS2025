...
public class Linie extends TemplateLinie{
    @Override
    ...
    protected void opresteStatia3() {
        System.out.println("Statia 3 cu usa pe partea dreapta");
    }

    @Override
    protected void opresteStatia4() {
        System.out.println("Statia 4 cu usa pe partea dreapta");
    }
    ...
    protected void opresteStatia6() {
        System.out.println("Statia 6 cu usa pe partea stanga");
    }
}
